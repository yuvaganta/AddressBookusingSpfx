...
import * as strings from 'SpfxAddressbookWebPartStrings';
...
export default class SpfxAddressbookWebPart extends BaseClientSideWebPart<ISpfxAddressbookWebPartProps> {
